...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create bbq-4907
  fly apps create bbq-4907-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app bbq-4907
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app bbq-4907-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'bbq-4907-staging' does not match app name in config file 'bbq-4907'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name bbq-4907-db
  fly postgres attach --app bbq-4907 bbq-4907-db

  fly postgres create --name bbq-4907-staging-db
  fly postgres attach --app bbq-4907-staging bbq-4907-staging-db
  ```
